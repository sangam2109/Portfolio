...
import HandleTechIcon from "../../utils/HandleIcons";
import './Project.css'
        ...
        <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 w-full mx-0 sm:mx-5">
          {projectData.map((value, index) => (
            <div
              ...
              />
              <motion.div
                className="absolute right-0 bottom-0 z-10 h-[182px] sm:h-[234px] md:h-[273px] lg:h-[299px] xl:h-[325px] w-[280px] sm:w-[360px] md:w-[420px] lg:w-[460px] xl:w-[500px] bg-nd-code-bg-4/5 backdrop-blur-md rounded-[15px] p-3 sm:p-5 md:p-6 lg:p-7 xl:p-8 shadow-md bg-gray-800 "
                initial="hidden"
                whileInView={"visible"}
                viewport={{ once: true, amount: 0.5 }}
