    ...
    >
      <div className="flex flex-col justify-center items-center w-full h-full text-white">
        ...
        <p className="py-6">
          ...
          <span className="font-bold">arorasam2109@gmail.com</span>
        </p>
        ...
        <div className="mt-4 mx">
          <button
            ...
            className="text-white border-2 px-6 py-3 my-2 flex items-center rounded-full font-semibold hover:bg-[#23c483] hover:shadow-md hover:text-[#fff] transform hover:-translate-y-7 transition duration-300 active:translate-y-[-1px]"
>
            Send Message
